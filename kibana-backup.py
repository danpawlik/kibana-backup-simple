...
def get_arguments():
    ...
    args_parser.add_argument('--tenant', help='Specify tenant for getting data.'
...
def make_request(url, user, password, text, tenant, insecure=False, retry=True):
    r = None
        ...
        if args.all_tenants:
            ...
            for tenant in all_tenants:
                backup(kibana_url, args.space_id, args.user, args.password,
                    ...
                    tenant, args.extension)
        else:
            backup(kibana_url, args.space_id, args.user, args.password,
                args.backup_dir, args.insecure,
                args.tenant, args.extension)
